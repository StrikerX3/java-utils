...
/**
 * <code>long</code>-based hash map which uses integer primitives as keys. This
 ...
 * <code>Map</code> into a <code>LongMap</code>. This implementation outperforms
 * a <code>Map&lt;Long, ?&gt;</code> in all operations by a significant margin,
 * especially on large collections.
 * <p>
...
public class LongMap<V> {
    ...
    */
    ...
    /**
     * Constructs an empty <code>LongMap</code> with the default initial
    ...
    /**
     * Constructs an empty <code>LongMap</code> with the specified initial
     ...
     */
    public LongMap(final int capacity, final float loadFactor) {
    ...
    /**
     * Constructs a new <code>LongMap</code> with the same mappings as the
     * specified <code>Map</code>. The <code>LongMap</code> is created with
     ...
     */
    public LongMap(final Map<Long, V> map) {
     ...
     */
    private static int hash(final long key, final int mask) {
    ...
    /**
     * Copies all of the mappings from the specified <code>LongMap</code> to
     * this map. These mappings will replace any mappings that this map had for
     * any of the keys currently in the specified map.
     *
     * @param m mappings to be stored in this map
     * @throws NullPointerException if the specified map is null
     */
    public void putAll(final LongMap<? extends V> m) {
     ...
     * 
     * @return an <code>long[]</code> with the keys contained in this map 
     */
    public long[] keys() {
    ...
    public static class Entry<T> {
        ...
        public Entry(final long key, final T value, final Entry<T> next) {
            this.key = key;
            this.value = value;
            this.next = next;
        }
    ...
    final class KeySet extends AbstractSet<Long> {
        ...
        public boolean remove(final Object o) {
            ...
            return LongMap.this.remove((Long) o) != null;
        }
     ...
     * returned by {@link LongMap#values()}.
     */
    final class Values extends AbstractCollection<V> {
        ...
        @Override
        public boolean contains(final Object o) {
            return LongMap.this.containsValue((V) o);
        }
     ...
     */
    final class MapEntrySet extends AbstractSet<Map.Entry<Long, V>> {
        @Override
    ...
    /**
     * Returns the entry associated with the specified key in the LongMap.
     * Returns null if the LongMap contains no mapping for the key.
     */
    Entry<V> getEntry(final long key) {
        final int hash = hash(key, capacityMask);
        for (Entry<V> e = table[hash]; e != null; e = e.next) {
            if (e.key == key) {
                return e;
    ...
    /**
     * Removes the entry associated with the specified key in the LongMap,
    ...
    /**
     * <code>Map</code> view of this map, returned by {@link LongMap#asMap()}.
     */
    final class MapView extends AbstractMap<Long, V> {
        @Override
        public int size() {
            return size;
        }
        ...
        @Override
        public V put(final Long key, final V value) {
            return LongMap.this.put(key, value);
        }
        ...
        public V get(final Object key) {
            ...
            return LongMap.this.get((Long) key);
        }
        ...
        public V remove(final Object key) {
            ...
            return LongMap.this.remove((Long) key);
        }

        @Override
        public void putAll(final Map<? extends Long, ? extends V> m) {
            LongMap.this.putAll(m);
        }

        @Override
        public Set<Long> keySet() {
            return LongMap.this.keySet();
        }

        @Override
        public Collection<V> values() {
            return LongMap.this.values();
        }
        ...
        public boolean containsKey(final Object key) {
            ...
            return LongMap.this.containsKey((Long) key);
        }

        @SuppressWarnings("unchecked")
        @Override
        public boolean containsValue(final Object value) {
            return LongMap.this.containsValue((V) value);
        }
     ...
     * @see LongMap#keySet()
     */
    final class KeyIterator extends HashIterator<Long> {
        @Override
        public Long next() {
     ...
     * @see LongMap#asMap()
     */
    final class MapEntryIterator extends HashIterator<Map.Entry<Long, V>> {
        @Override
     ...
     */
    Iterator<Map.Entry<Long, V>> newMapEntryIterator() {
