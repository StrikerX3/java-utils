 ...
 * (typically UNIX-like platforms adopt <code>lib</code>, whereas Windows platforms do not use a prefix)</li>
...
public class NativeLibraryHelper {
	...
	public static void load(final String path, final String libName) throws IOException {
		...
		final InputStream input = NativeLibraryHelper.class.getClassLoader().getResourceAsStream(resourcePath);
		if (input == null) {
